        ...
        <div className="space-y-4 md:space-y-5">
          ...
          <div className="space-y-2.5">
            ...
            <button 
              ...
              className="w-full py-3.5 rounded-2xl font-black uppercase tracking-wider text-[11px] bg-gray-100 hover:bg-gray-200 text-gray-700 transition-all flex items-center justify-center gap-2 active:scale-95"
            >
              <Shield size={16} className="text-gray-500" />
              <span>Continuer sans connexion (Accès Libre)</span>
            </button>
          </div>
